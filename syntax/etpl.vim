...
" eg: <!-- target: test -->
syntax match etplDefStart /<!--.\{-}:.\{-}-->/ contains=etplMarkerStart,etplMarkerEnd,etplCommandStart,etplFunction,etplVariable
" eg: <!-- /target -->
syntax match etplDefEnd /<!--\s*\/.\{-}-->/ contains=etplMarkerStart,etplMarkerEnd,etplCommandEnd
